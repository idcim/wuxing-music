...
> 详细产品/设计/数据规范见 [CLAUDE.md](CLAUDE.md)；**部署与域名配置见 [docs/DEPLOY.md](docs/DEPLOY.md)**。
...
- [x] **H5 端（微信内）：手机登录（验证码+密码）+ 微信网页授权登录 + 微信支付（JSAPI）**（v1.1，见 [docs/ROADMAP.md](docs/ROADMAP.md)）
